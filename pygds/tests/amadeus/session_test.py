...
class SessionHolderCan(TestCase):
    ...
    def add_session(self):
        session_info = AmadeusSessionInfo("tok9999", 1, "fake-session-id")
    ...
    def get_session_info(self):
        session_info = AmadeusSessionInfo("tok9999", 1, "fake-session-id-2")
        self.holder.add_session(session_info)
    ...
    def remove_session(self):
        session_info = AmadeusSessionInfo("tok9999", 1, "fake-session-id-3")
        self.holder.add_session(session_info)
    ...
    def update_session_sequence(self):
        session_info = AmadeusSessionInfo("tok9999", 1, "fake-session-id-4")
        self.holder.add_session(session_info)
