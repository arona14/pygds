...
class SessionHolderCan(TestCase):
    ...
    def test_add_session(self):
        ...
        self.holder.save_session(session_info)
        self.assertFalse(self.holder.contains_session("fake-message-id"), "The holder didn't take the giving session")

    def test_add_empty_session(self):
        self.assertRaises(ValueError, self.holder.save_session, None)  # "Adding empty session is not raising ValueError"
    ...
    def test_update_session_sequence(self):
        ...
        # self.assertIsNone(read_session, "No session found in the holder")
    ...
    def test_tell_contains_session(self):
        ...
        self.assertFalse(contains, "The holder doesn't contain the added session")
