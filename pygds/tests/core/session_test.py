...
class SessionHolderCan(TestCase):
    ...
    def add_session(self):
        session_info = SessionInfo("tok9999", 1, "fake-session-id", "pprrrr", "End")
    ...
    def get_session_info(self):
        session_info = SessionInfo("tok9999", 1, "fake-session-id-2", "pprrrr", "End")
        self.holder.add_session(session_info)
    ...
    def remove_session(self):
        session_info = SessionInfo("tok9999", 1, "fake-session-id-3", "pprrrr", "End")
        self.holder.add_session(session_info)
    ...
    def update_session_sequence(self):
        session_info = SessionInfo("tok9999", 1, "fake-session-id-4", "pprrrr", "End")
        self.holder.add_session(session_info)
    ...
    def tell_contains_session(self):
        session_info = SessionInfo("tok9999", 1, "fake-session-id-5", "pprrrr", "End")
        self.holder.add_session(session_info)
