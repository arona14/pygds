...
class GetPnrResponseExtractor(BaseResponseExtractor):
    ...
    def _segments(self):
        ...
        for data in ensure_list(self.payload["originDestinationDetails"]["itineraryInfo"]):
            ...
            segment_data = FlightSegment(index, "", departure_date_time, departure_airport, arrival_date_time,
                                         arrival_airport, "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                                         class_of_service, "", equipment_type, "", "", "")
            ...
            segment_data = FlightSegment(index, resbook_designator, departure_date_time, departure, arrival_date_time,
                                         arrival, status, quantity, marketing_airline, operating_airline, "", "", "",
                                         "", "", "", "", "", "", "", "", equipment_type, "", "")
            index += 1
    ...
    def _passengers(self):
        ...
        for traveller in ensure_list(from_json(self.payload, "travellerInfo")):
            ...
            passsenger = Passenger(pax_reference, firstname, lastname, date_of_birth, "", "", "", action_code,
    ...
    def _pnr_info(self):
        ...
        for data in self.payload["pnrHeader"]["reservationInfo"]["reservation"]:
            reservation_info = {
                'compagny_id': from_json_safe(data, "companyId"),
                'control_number': from_json_safe(data, "controlNumber")
            }
            ...
            pnr_infos.append(reservation_info, dk)
        return pnr_infos
