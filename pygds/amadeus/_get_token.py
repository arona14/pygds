...
def generate_token(message_id: str, sequence: int, session_id: str, security_token: str):
    ...
    token = jwt.encode({'exp': datetime.datetime.utcnow() + datetime.timedelta(seconds=duration), "info_token": f"""{message_id}, {sequence}, {session_id}, {security_token}"""}, key, algorithm)
    return token
...
if __name__ == "__main__":
    ...
    print(token_decode["info_token"].split(","))
