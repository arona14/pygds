...
def add_flight_segment(origin, destination, depart_date, operating_code, operating_flight_number, arrival_date, class_of_service, currency_code):
    ...
    return f"""<tag0:Flight origin="{origin}" destination="{destination}">
      ...
      <tag0:Marketing carrier="{operating_code}">{operating_flight_number}</tag0:Marketing>
